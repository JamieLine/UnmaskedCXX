...
bool SampleCXXProject_Calculations1() {
	...
	for (int i = 0; i < 10; i++) {
		...
		ReturnedValues[i] = LinearCombination(0,std::get<1>(GeneratedArguments[i]),0,std::get<3>(GeneratedArguments[i]));
	}
...
/*int main(int argc, char** argv) {
	SampleCXXProject_Calculations1();
}*/